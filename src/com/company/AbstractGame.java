...
//    public Player getNextPlayer();
    ...
    public abstract String howToMove(String color); //how to play (dice or Square selection etc...) - Press Enter to throw the dice / choose source square and destination square / choose square to put piece
